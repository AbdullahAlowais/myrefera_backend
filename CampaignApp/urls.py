...
urlpatterns = [
    ...
    path('influencerdata/<int:id>',InfluencerData.as_view(),name="influencerdata"),
    path('paidstatus/',PaidStatus.as_view(),name="paidstatus"),
    path('inflwebsitelist/',InfluencerWebsiteList.as_view(),name="inflwebsitelist"),
    path('allcampaign/',AllCampaign.as_view(),name="allcampaign"),
    path('marketcampaign/',MarketAllCampaign.as_view(),name="marketcampaign"),
